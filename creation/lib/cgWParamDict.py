...
class glideinMainDicts(cgWDictFile.glideinMainDicts):
    ...
    def populate(self, other=None):
        ...
        # initialize an empty dictionary to capture all the feature flags defined in the configuration
        feature_flags = {}
        ...
        for script_name in after_file_list_scripts:
            if script_name == "cvmfs_umount.sh" and "cvmfsexec" in feature_flags:
